										...
										if (mysqli_num_rows($result) > 0) {
											...
											while($row = mysqli_fetch_assoc($result)) {
											  echo '<tr class="odd gradeX">';
												echo "<td><center>".$row['id_kord']."</center></td>";
												echo "<td>".$row['nama_kord']."</td>";
												echo "<td>".$row['nip_kord']."</td>";
											  echo "<td><center>
														<a href=edit_kordinator.php?id_kord=$row[id_kord]><span class='label label-warning'>EDIT</span> </a></center>";
											}
										}else {
											echo "0 results";
										}
