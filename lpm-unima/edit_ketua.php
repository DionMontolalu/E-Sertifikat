			...
			<div class="main-page">
				<div class="forms">
					...
					<?php
						...
						$show = mysqli_query($conn,"SELECT * FROM ketua WHERE id_ketua='$id_ketua'");
					...
					?>
                        ...
                        if (isset($_POST['input'])) {
                            ...
                            if($nama==""){
                                ...
                                echo '<script>swal("Kesalahan!", "Form Nip tidak boleh kosong!", "warning")</script>';
                                    ...
                                    //insert ke tabel
                                    $query = "UPDATE ketua SET nama_ket='$nama',nip_ket='$nip' WHERE id='$id'";
                                    ...
                                    if ($sql){
                                        echo '<script>
												...
												function(){
													window.location.href = "view_ketua.php";
												});
											  </script>';
									}elseif (!$sql){
						...
						<div class="form-three widget-shadow">
							...
							<input type="hidden" name="id" value="<?php echo $id_ketua; ?>">
								<div class="form-group"> 
									<label>Nama Ketua</label> 
									<input type="text" name="nama" class="form-control" value="<?php echo $data['nama_ket']; ?>" placeholder="Nama Lengkap"> 
								</div> 
								<div class="form-group"> 
									<label>NIP Ketua</label> 
									<input type="text" name="nip" class="form-control" value="<?php echo $data['nip_ket']; ?>" placeholder="Nomor Induk Pegawai"> 
								</div> 							
