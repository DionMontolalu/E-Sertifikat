										...
										if (mysqli_num_rows($result) > 0) {
											...
											while($row = mysqli_fetch_array($result)) {
											  echo '<tr class="odd gradeX">';
												echo "<td>".$row['id_sert']."</td>";
												echo "<td>".$row['nama']."</td>";
												echo "<td><center>".$row['nim']."</center></td>";
												echo "<td><center>".$row['ttl']."</center></td>";
												echo "<td>".$row['fakultas']."</td>";
												echo "<td>".$row['lokasi_kkn']."</td>";
												echo "<td><center><a href=mahasiswa_view.php?id_sert=$row[id_sert]><span class='label label-warning'>Lihat</span> </a>
															<a href = # onClick=\"popup_print($row[id_sert])\"><span class='label label-success'>Cetak</span> </a> <br>
															<a href = # onClick=\"popup_nilai($row[nim])\"><span class='label label-info'>Cetak Nilai</span> </a>
														</center></td>";
												echo "</tr>";
											}
										}else {
